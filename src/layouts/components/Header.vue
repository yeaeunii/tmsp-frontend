...
<nav
  class="flex w-full items-center justify-between px-6 py-4 lg:px-8" aria-label="Global">

      <div class="flex lg:flex-1">
        <RouterLink to="/" class="-m-1.5 p-1.5">
          <span class="sr-only">메인인</span>
          <img class="h-8 w-auto" :src="logoUrl" alt="로고" />
        </RouterLink>
      </div>
...
<script setup>
import { ref } from 'vue'
import logoUrl from '@/assets/board-pink.svg'
import {
  Dialog,
  DialogPanel,
  Disclosure,
